            ...
            <div className="flex flex-col lg:flex-row lg:items-center p-3 py-6 md:p-5 lg:p-10 gap-2">
              ...
              <div className="lg:ms-5">
                ...
                <p className="text-start text-white-100 font-semibold">
                  {card.company
                    ? `${card.company} | ${formatDateRange(card.startDate, card.isCurrentPosition, card.endDate)}`
                    : formatDateRange(
                        card.startDate,
                        card.isCurrentPosition,
                        card.endDate
                      )}
                </p>
                <div className="text-start text-white-100 mt-3 font-semibold rich-text-container">
